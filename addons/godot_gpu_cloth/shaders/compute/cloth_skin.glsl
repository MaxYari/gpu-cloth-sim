...
// Each bone matrix already encodes: cloth_inv * skel_global * bone_global_pose * bind_pose
// so the output is directly in cloth-solver local space.
...
mat4 fetch_bone_matrix(uint bone_id) {
    ...
    // mat4 constructor takes columns
    return mat4(
